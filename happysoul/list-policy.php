...
<?php include 'layouts/body.php'; 
    ...
    if (isset($_POST['policyid'])) {
        ...
        $query = "DELETE from tblpolicy where iPolicyId   = ?";
        $stmt = mysqli_prepare($link,$query);
        mysqli_stmt_bind_param($stmt, "i", $_POST['policyid']);
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">List Policy</h4>

                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Policy</a></li>
                                    <li class="breadcrumb-item active">List Policy</li>
                                </ol>
                            </div>
                ...
                <table id="datatable" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <?php         
                            $count = 0;
                            $stmt1 = $link->prepare("Select * from tblpolicy");
                            $stmt1->execute();
                        ...
                        <td><?php echo htmlentities($count, ENT_QUOTES);?></td>
                            ...
                            <!-- <td>
                              <form action="add-item.php" method="post">
                                <input type="hidden" name="policyid" value="<?php //echo htmlentities($row1['iPolicyId'], ENT_QUOTES);?>">
                            ...
                            <td>
                              <form action="list-policy.php" method="post">
                                <input type="hidden" name="policyid" value="<?php echo htmlentities($row1['iPolicyId'], ENT_QUOTES);?>">
